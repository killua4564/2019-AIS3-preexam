### TCash
- 題目把flag每個字拿去做md5和sha256 mod 64
```
...
sha256m = {}
for c in cand:
	md5m[c] = int(md5(c.encode()).hexdigest(), 16) % 64
	sha256m[c] = int(sha256(c.encode()).hexdigest(), 16) % 64
...
- [name=][seadog007](https://www.facebook.com/photo.php?fbid=2549242185096399)